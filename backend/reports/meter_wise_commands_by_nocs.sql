-- Meter-wise RC/DC Commands filtered by NOCS
-- Returns detailed meter list for a specific NOCS location
-- Parameters: :nocsName - NOCS location name
