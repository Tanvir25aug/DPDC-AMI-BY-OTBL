-- DC In Progress - Detailed Report with Customer Information
-- Returns all DC commands currently in progress with full details
...
INNER JOIN d1_activity PARTITION({{PARTITION}}) l ON l.D1_ACTIVITY_ID = k.D1_ACTIVITY_ID
    AND l.activity_type_cd = 'REMOTEDISCONNECT'
