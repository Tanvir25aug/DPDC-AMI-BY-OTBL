-- Remote Connect/Disconnect Analytics Summary - Detailed Transaction View
-- This report provides detailed RC/DC transactions with customer, meter, and financial information
-- Same structure as auto_connect_disconnect_details.sql from reference project
...
inner join d1_activity partition({{PARTITION}}) l on l.D1_ACTIVITY_ID=k.D1_ACTIVITY_ID and l.activity_type_cd in ('REMOTEDISCONNECT','REMOTECONNECT')
